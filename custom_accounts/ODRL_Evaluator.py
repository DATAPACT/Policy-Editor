...
import custom_accounts.Evaluation.evaluator_functions
import custom_accounts.rdf_utils as rdf_utils
import custom_accounts.SotW_generator as SotW_generator
import pandas as pd
import custom_accounts.validate as validate
import operator
...
def evaluate_ODRL_from_files_merge_policies(policy_files, SotW_file):
    ...
    df = pd.read_csv(io.StringIO(SotW_file))
